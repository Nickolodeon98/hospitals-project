...
public class HospitalDao {
    ...
    public void add() throws IOException {
        List<Hospital> hospitalList = readLineContext.readLines("C:\\LikeLion\\2022.10\\ing\\spring-boot\\fulldata_01_01_02_P_의원 (3).csv");
    ...
    public String findById(String id) {
        ...
        Hospital queryHospital = jdbcTemplate.queryForObject(sql, new RowMapper<Hospital>() {
            ...
            public Hospital mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                hospital.setLicenseDate(LocalDateTime.of(Integer.parseInt(rs.getString("license_date").substring(0,4)), Integer.parseInt(rs.getString("license_date").substring(4,6)),
                        Integer.parseInt(rs.getString("license_date").substring(6,8)), 0, 0, 0));
